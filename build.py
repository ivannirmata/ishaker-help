...
.checklist li{margin-bottom:10px;display:flex;align-items:flex-start;gap:10px;}
.checklist input{margin-top:5px;width:17px;height:17px;flex:none;}
"""
...
<ul class="checklist">
<li><label><input type="checkbox"> Заголовок — с точки зрения оператора.</label></li>
<li><label><input type="checkbox"> Есть RU и EN.</label></li>
<li><label><input type="checkbox"> Шаги проверены на реальной машине.</label></li>
<li><label><input type="checkbox"> Скриншоты без серийников и внутренностей.</label></li>
<li><label><input type="checkbox"> Тон без обещаний результата, от «our team».</label></li>
<li><label><input type="checkbox"> Нет паролей/доступов/внутренней кухни.</label></li>
<li><label><input type="checkbox"> Термины сверены с машиной.</label></li>
</ul>"""
